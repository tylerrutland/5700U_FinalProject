...
public class VEA1 {
    ...
    public VEA1(String password) {
        ...
        m_bfish = new veaCBC(digest.digest(), 0);
        digest.reset();
    }
                          ...
                          long lNewCBCIV)
    {
        ...
        byte[] newCBCIV = new byte[veaCBC.BLOCKSIZE];
        longToByteArray(lNewCBCIV,
                newCBCIV,
                0);

        return bytesToBinHex(newCBCIV, 0, veaCBC.BLOCKSIZE) +
    ...
    public String decryptString(String sCipherText)
    {
        ...
        if (nLen < veaECB.BLOCKSIZE)
            return null;

        // get the CBC IV
        byte[] cbciv = new byte[veaCBC.BLOCKSIZE];
        int nNumOfBytes = binHexToBytes(sCipherText,
                cbciv,
                0,
                0,
                veaCBC.BLOCKSIZE);
        if (nNumOfBytes < veaCBC.BLOCKSIZE)
            return null;
    ...
    /**
     * implementation of the VEA encryption algorithm in ECB mode
     * @author Markus Hahn <markus_hahn@gmx.net>
     * @version Feburary 14, 2001
     */
    private static class veaECB
    {
        ...
        public static boolean selfTest()
        {
            ...
            veaECB testbf1 = new veaECB(testKey1);
            ...
            veaECB testbf2 = new veaECB(testKey2);
    ...
    private static class veaCBC extends veaECB {
